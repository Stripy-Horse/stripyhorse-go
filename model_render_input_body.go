...
// checks if the RenderInputBody type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenderInputBody{}

// RenderInputBody struct for RenderInputBody
...
type _RenderInputBody RenderInputBody
...
func (o RenderInputBody) MarshalJSON() ([]byte, error) {
...
func (o RenderInputBody) ToMap() (map[string]interface{}, error) {
...
func (o *RenderInputBody) UnmarshalJSON(data []byte) (err error) {
	...
	varRenderInputBody := _RenderInputBody{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRenderInputBody)

	if err != nil {
		return err
	}

	*o = RenderInputBody(varRenderInputBody)

	return err
}

type NullableRenderInputBody struct {
	value *RenderInputBody
	isSet bool
}

func (v NullableRenderInputBody) Get() *RenderInputBody {
	return v.value
}

func (v *NullableRenderInputBody) Set(val *RenderInputBody) {
	v.value = val
	v.isSet = true
}

func (v NullableRenderInputBody) IsSet() bool {
	return v.isSet
}

func (v *NullableRenderInputBody) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenderInputBody(val *RenderInputBody) *NullableRenderInputBody {
	return &NullableRenderInputBody{value: val, isSet: true}
}

func (v NullableRenderInputBody) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenderInputBody) UnmarshalJSON(src []byte) error {
	v.isSet = true
